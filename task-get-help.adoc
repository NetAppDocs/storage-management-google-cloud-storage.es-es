...
Para obtener asistencia técnica relacionada con un servicio de archivos de un proveedor de nube, su infraestructura o cualquier solución que utilice el servicio, consulte la documentación de ese producto.
...
* Documentación
+
La documentación de la consola de NetApp que estás viendo actualmente.
...
+
Únase a la comunidad de la consola de NetApp para seguir las discusiones en curso o crear otras nuevas.
...
.Pasos
. En la consola de NetApp , seleccione *Ayuda > Soporte*.
